...
model = SGDClassifier(loss='hinge', penalty='l2', shuffle=False, class_weight={1:83.3, 0:1.0}) # classes are weighted in the loss to balance ratio or y=1 samples to y=0
